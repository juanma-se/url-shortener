...
const ShortenLinkForm = () => {
    ...
    const isProcessing = false//processing || !data.turnstileToken;
                    ...
                    <Card className="h-fit overflow-hidden">
                        <form onSubmit={handleSubmit} className="w-full flex flex-col gap-6">
                            <div className="grid gap-6 xl:grid-cols-2">
                                <LabelInput>
                                    Acortar URL
                                    <Input type="url" name="url" required placeholder="https://tu-url-super-mega-larga-de-ejemplo.com" onChange={handleChange} value={data.url} disabled={isProcessing} />
